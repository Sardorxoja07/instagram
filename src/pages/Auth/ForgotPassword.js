...
const ForgotPassword = () => {
  ...
  return (
    <div className="bg-yellow-50 h-screen w-screen flex flex-wrap items-center justify-center p-3">
      <Helmet>
        <title>Forgot Password</title>
      </Helmet>
      <div className="w-[350px] grid gap-y-3">
        <div className="bg-pink-50 border px-[40px] pt-10 pb-6">
          ...
          <form onSubmit={handleSubmit} className="" method="post">
            ...
            <div className="flex justify-center items-center flex-col w-full bg-pink-50">
              <p className="text-sm">
                <Link
                  to={LOGIN}
